...
function paymentCard(kind){
 ...
 if(kind==='pending'){statusLabel='Перевіряємо оплату';note='Це може зайняти декілька секунд.';action=`<button class="btn secondary" id="btn-refresh-status">Оновити статус</button>`}
